...
def handle_btn_get_info():
    ...
    if poke_info:
        ...
        bar_sp_attack['value'] = poke_info['stats'][3]['base_stat']
        bar_sp_defense['value'] = poke_info['stats'][4]['base_stat']
...
lbl_height_val.grid(row=0, column=1, padx=(5, 10), pady=10)
...
lbl_weight_val.grid(row=1, column=1, padx=(5, 10), pady=10)
...
lbl_type_val.grid(row=2, column=1, padx=(5, 10), pady=10)
...
bar_hp = ttk.Progressbar(frm_stats, length=PRG_BAR_LENGTH, maximum=STATE_MAX_VALUE)
...
bar_attack = ttk.Progressbar(frm_stats, length=PRG_BAR_LENGTH, maximum=STATE_MAX_VALUE)
...
bar_defense = ttk.Progressbar(frm_stats, length=PRG_BAR_LENGTH, maximum=STATE_MAX_VALUE)
bar_defense.grid(row=2, column=1, padx=(0, 10), pady=5)

lbl_sp_attack = ttk.Label(frm_stats, text="Special Attack:")
lbl_sp_attack.grid(row=3, column=0, padx=(10, 5), pady=5, sticky=E)

bar_sp_attack = ttk.Progressbar(frm_stats, length=PRG_BAR_LENGTH, maximum=STATE_MAX_VALUE)
bar_sp_attack.grid(row=3, column=1, padx=(0, 10), pady=5)

lbl_sp_defense = ttk.Label(frm_stats, text="Special Defense:")
lbl_sp_defense.grid(row=4, column=0, padx=(10, 5), pady=5, sticky=E)

bar_sp_defense = ttk.Progressbar(frm_stats, length=PRG_BAR_LENGTH, maximum=STATE_MAX_VALUE)
bar_sp_defense.grid(row=4, column=1, padx=(0, 10), pady=5)

lbl_speed = ttk.Label(frm_stats, text="Speed:")
lbl_speed.grid(row=5, column=0, padx=(10, 5), pady=5, sticky=E)

bar_speed = ttk.Progressbar(frm_stats, length=PRG_BAR_LENGTH, maximum=STATE_MAX_VALUE)
